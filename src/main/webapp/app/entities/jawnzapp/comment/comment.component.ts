...
export class CommentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.commentService
        ...
        .subscribe(
          (res: HttpResponse<IComment[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IComment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
