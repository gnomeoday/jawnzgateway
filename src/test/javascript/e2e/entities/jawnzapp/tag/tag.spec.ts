...
describe('Tag e2e test', () => {
  ...
  it('should create and save Tags', async () => {
    ...
    await promise.all([tagUpdatePage.setTextInput('&#39;Wb5'), tagUpdatePage.commentSelectLastOption()]);

    expect(await tagUpdatePage.getTextInput()).to.eq('&#39;Wb5', 'Expected Text value to be equals to &#39;Wb5');
